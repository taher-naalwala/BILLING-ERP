        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4 ">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Edit Ledger</h6>
                </div>
                <div class="card-body">
            ...
            ?>
                <div class="card shadow mb-4 ">
                    ...
                    <div class="card-body">
                        ...
                        $sql="SELECT id,ledger_id,agency_id,type,amount,finish_date FROM ledger2 WHERE student_id=$s_id ORDER BY date DESC";
                        ?>

                        <div class="table-responsive">
                            <table border=1 id="dataTable2" class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th>Agency</th>
                                        <th>Type</th>
                                ...
                                <tbody>
                                    ...
                                    while ($row = $run->fetch_assoc()) {
                                        ...
                                        list($f_y_, $f_m_, $f_d_) = explode('-', $finish_date);
                                        $f_first0_ =  $f_m_ . "/" . $f_d_. "/". $f_y_ ;
                                        ...
                                        $final_amount = $amount;
                                        $s1="SELECT due_date, install_num from ledger WHERE id=$ledger_id";
                                        $run1=$conn->query($s1);
                                        ...
                                        <tr>
                                            ...
                                            <form method="POST">
                                                ...
                                                <td><?php echo $due_date ?></td>
                                                 <td><input placeholder="Date" name="date" type="text" value="<?php echo $final_date ?>" class="form-control datepicker" required></td>
                                                <td><button name="edit" class="btn btn-primary" value="<?php echo $ledger2_id ?>">Submit</button></td>
                                                <td><button name="delete" class="btn btn-danger" value="<?php echo $ledger2_id ?>">Delete</button></td>
                                    ...
                                    if (isset($_POST['edit'])) {
                                       $ledger2_id = $_POST['edit'];
                                        ...
                                        $sql = "UPDATE ledger2 SET amount='$amount',finish_date='$final_date',date='$ledger_date',time='$ledger_time' WHERE id=$ledger2_id";
                                    ...
                                    if (isset($_POST['delete'])) {
                                        $ledger_id = $_POST['delete'];
                                     
                                            $s1 = "DELETE from ledger2 WHERE id=$ledger_id";
