                    ...
                    <div class="card shadow mb-4 ">
                        ...
                        <div class="card-body">
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                $dob_0 = $_POST['dob'];
                                list($f_m_, $f_d_, $f_y_) = explode('/', $dob_0);
                                $f_first0_ = $f_y_ . "-" . $f_m_ . "-" . $f_d_;
                                $dob = str_replace(' ', '', $f_first0_);
                                $fees = $_POST['fees'];
                                ...
                                $s1 = "SELECT COUNT(*) as c_1 from student_info WHERE name='$student_name' AND dob='$dob' AND fees='$fees' AND commission='$commission' AND country_id=$country_id AND university_id=$university_id AND campus_id=$campus_id AND student_id='$student_id' AND visa_number='$visa_number' AND course='$course' AND semester='$semester'";
                                $run = $conn->query($s1);
                                ...
                                if ($c_1 > 0) {
                                    ...
                                    $timestamp = $c_d . " " . (date("h:i:sa"));
                                    $sql = "INSERT INTO student_info VALUES('','$student_name','$dob','$fees','$commission',$country_id,$university_id,$campus_id,'$student_id','$visa_number','$course','$semester',1,'$timestamp')";
                                    if (mysqli_query($conn, $sql)) {
                                        $s1_1 = "SELECT id from student_info WHERE name='$student_name' AND dob='$dob' AND fees='$fees' AND commission='$commission' AND country_id=$country_id AND university_id=$university_id AND campus_id=$campus_id AND student_id='$student_id' AND visa_number='$visa_number' AND course='$course' AND semester='$semester'";
                                        $run_1 = $conn->query($s1_1);
                                        $row_1_1 = $run_1->fetch_assoc();
                                        $id = $row_1_1['id'];
                                     
                                        foreach ($agency_id as $index => $agency) {

                                            list($f_m, $f_d, $f_y) = explode('/', $due_date_0[$index]);
                                            $f_first0 = $f_y . "-" . $f_m . "-" . $f_d;
                                            $due_date = str_replace(' ', '', $f_first0);

                                            $s3 = "INSERT INTO ledger VALUES('',$id,$agency,$type_id[$index],$install_num[$index],'$amount[$index]','$due_date',1,'','')";
                    ...
                    <div class="card shadow mb-4 ">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input placeholder="Enter Student Date of Birth" name="dob" type="text" class="form-control datepicker" required>
                            </div>
                            <div class="form-group">
                                <label>Student ID</label>
                                <input placeholder="Enter Student ID" name="student_id" type="text" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Visa Number</label>
                                <input placeholder="Enter Visa Number" name="visa_number" type="text" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Course</label>
                                <input placeholder="Enter Course" name="course" type="text" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Semester</label>
                                <input name="semester" id="semester" placeholder="Enter Semester" class="form-control" readonly required />
                            </div>
                            <div class="form-group">
                                <label>Fees</label>
                                <input placeholder="Enter Total Fees" name="fees" type="number" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Commission</label>
                                <input placeholder="Enter Total Commission" name="commission" type="number" class="form-control" required>
                            </div>
                        </div>
                    </div>
                    <div class="card shadow mb-4 ">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered" id="dynamic_field">
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" name="install_num[]" class="form-control" placeholder="Installment" required>
                                        ...
                                        <td>
                                            <input placeholder="Due Date" name="due_date[]" type="text" class="form-control datepicker" required>
                                        </td>
...
<?php
    ...
    <?php
                if (isset($_POST['submit'])) {
                    ...
                    $sql = "SELECT COUNT(*) as c_2 from country_info WHERE name='$name'";
                    $run = $conn->query($sql);
                    ...
                    if ($c_2 > 0) {
                        ...
                        $s1 = "INSERT INTO country_info VALUES('','$name')";
    ...
    <form method="POST">
        <div class="container">
            <div class="form-group">
                ...
                <input name="name" placeholder="Enter Country Name" class="form-control" required>
            </div>
...
<?php
    ...
    <?php
                if (isset($_POST['submit'])) {
                    $name = strtoupper($_POST['name']);
                    $sql = "SELECT COUNT(*) as c_3 from agency_info WHERE name='$name'";
                    $run = $conn->query($sql);
                    $row_3 = $run->fetch_assoc();
                    $c_3 = $row_3['c_3'];
                    if ($c_3 > 0) {
                        echo '<div class="alert alert-warning mt-2">
                        ...
                        $s1 = "INSERT INTO agency_info VALUES('','$name')";
                        if (mysqli_query($conn, $s1)) {
                            echo '<div class="alert alert-success mt-2">
                                        Success
                                        </div>';
    ...
    <form method="POST">
        <div class="container">
            <div class="form-group">
                ...
                <input name="name" placeholder="Enter Agency Name" class="form-control" required>
            </div>
...
<?php
    ...
    <?php
                ...
                if (isset($_POST['adduni'])) {
                    $country_id = $_POST['country_id'];
                    $name = strtoupper($_POST['name']);
                    $sql = "SELECT COUNT(*) as c_4 from university_info WHERE name='$name' AND country_id=$country_id";
                    $run = $conn->query($sql);
                    $row_4 = $run->fetch_assoc();
                    $c_4 = $row_4['c_4'];
                    if ($c_4 > 0) {
                        echo '<div class="alert alert-warning mt-2">
            University Already Exists
                        ...
                        $s1 = "INSERT INTO university_info VALUES('','$name',$country_id)";
                        if (mysqli_query($conn, $s1)) {
                            echo '<div class="alert alert-success mt-2">
                Success
                </div>';
    ...
    <form method="POST">
        ...
        <button name="adduni" value="Add" class="btn btn-primary btn-block">Add</button>
...
?>
    <?php
                ...
                if (isset($_POST['submit'])) {
                    $university_id = $_POST['university_id'];
                    $name = strtoupper($_POST['name']);
                    $sql = "SELECT COUNT(*) as c_5 from campus_info WHERE name='$name' AND university_id=$university_id";
                    $run = $conn->query($sql);
                    $row_5 = $run->fetch_assoc();
                    $c_5 = $row_5['c_5'];
                    if ($c_5 > 0) {
...
Campus Already Exists
                        ...
                        $s1 = "INSERT INTO campus_info VALUES('',$university_id,'$name')";
                        if (mysqli_query($conn, $s1)) {
                            echo '<div class="alert alert-success mt-2">
Success
</div>';
...
Fail
    ...
    <form method="POST">
        ...
        <div class="form-group">
            ...
            <input name="name" type="text" placeholder="Enter Campus Name" class="form-control" required>
        </div>
...
<?php }
    ...
    <?php
                ...
                if (isset($_POST['addaccess'])) {
                    ...
                    $sql = "SELECT COUNT(*) as c_6 from web_login WHERE username='$username' ";
                    $run = $conn->query($sql);
                    $row_6 = $run->fetch_assoc();
                    $c_6 = $row_6['c_6'];
                    if ($c_6 > 0) {
...
Account Already Exists
                        ...
                        $s1 = "INSERT INTO web_login VALUES('','$username','$pass','$name','$role')";
                        if (mysqli_query($conn, $s1)) {
                            $s2 = "SELECT id from web_login WHERE username='$username' ";
                            $run1 = $conn->query($s2);
...
Fail
    ...
    <form method="POST">
        ...
        <div class="form-group">
            <label>Powers</label>
            <select name="powers[]" placeholder="Choose Powers" class="choices-multiple-remove-button" multiple required>
        ...
        ?>
            <div class="card shadow mb-4 ">
                ...
                <div class="card-body">
                                ...
                                if ($('#userImage1').val()) {
                                    ...
                                    $(this).ajaxSubmit({
                                        ...
                                        uploadProgress: function(event, position, total, percentComplete) {
                                            ...
                                            $("#progress-bar1").html('<div id="progress-status1">' + percentComplete + ' %</div>')
                                        },
                                        success: function() {
                    ...
                    <form id="uploadForm" action="upload.php?type=profile&s_id=<?php echo $s_id ?>" method="post">

                        <label>Student Image:</label>
                        <input name="userImage" id="userImage" type="file" class="demoInputBox" required />

                        <input type="submit" class="btn btn-info" id="btnSubmit" value="Upload" class="btnSubmit" />
                        <div id="progress-div">
                    ...
                    <br>
                    <form id="uploadForm1" action="upload.php?type=visa&s_id=<?php echo $s_id ?>" method="post">

                        <label>Visa Image:</label>
                        <input name="userImage1" id="userImage1" type="file" class="demoInputBox" required />

                        <input type="submit" class="btn btn-info" id="btnSubmit1" value="Upload" class="btnSubmit" />
